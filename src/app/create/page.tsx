      ...
      <main className="pt-20 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">Create New App</h1>
            <p className="text-zinc-400">
              Describe your idea and our AI agents will build it
            </p>
          </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 sm:p-6">
            <div className="flex gap-3">
              <textarea
                ...
                className="flex-1 min-h-[200px] bg-zinc-800 border border-zinc-700 rounded-xl p-4 resize-none focus:outline-none focus:border-purple-500"
                disabled={isCreating}
              />
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
              ...
              <p className="text-sm text-zinc-400">
                Our 8-agent pipeline analyzes your requirements, designs the database, generates code, 
                and deploys to Vercel + Netlify.
              </p>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-purple-400 font-bold">~5 min</span>
                <span className="font-medium">Typical build time</span>
              </div>
              <p className="text-sm text-zinc-400">
                Complex apps may take longer. You&apos;ll receive a link to your deployed app via email.
              </p>
            </div>
          </div>
        </div>
